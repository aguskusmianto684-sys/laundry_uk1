                ...
                <div class="col-md-12">
                    <div class="card shadow-lg">
                        <div class="card-header d-flex align-items-center justify-content-between"
                            ...
                            <h5 class="mb-0">Tabel Member</h5>
                            <a href="create.php" class="btn btn-primary">Tambah</a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="memberTable" class="table table-bordered table-hover table-striped align-middle">
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a href="../../actions/member/destroy.php?id=<?= $item->id ?>"
                                            ...
                                            ?>
                                            <tr>
                                                <td colspan="6" class="text-center text-muted">Belum ada data Pelaanggan</td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
