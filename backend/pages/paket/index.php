...
// Ambil data paket + join outlet
$qPaket = "SELECT p.*, o.nama AS nama_outlet 
           FROM tb_paket p
           JOIN tb_outlet o ON p.outlet_id = o.id
           ORDER BY p.id DESC";
$result = mysqli_query($connect, $qPaket) or die(mysqli_error($connect));
?>
                ...
                <div class="col-md-12">
                    <div class="card shadow-lg">
                        <div class="card-header d-flex align-items-center justify-content-between"
                            ...
                            <h5 class="mb-0">Tabel Paket</h5>
                            <a href="create.php" class="btn btn-primary">Tambah</a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="paketTable" class="table table-bordered table-hover table-striped align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= htmlspecialchars($item->nama_outlet) ?></td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="../../actions/paket/destroy.php?id=<?= $item->id ?>"
