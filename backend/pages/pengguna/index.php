...
$page = "pengguna"; // halaman aktif
include __DIR__ . '/../../../config/connection.php';
include '../../partials/header.php';
include '../../partials/sidebar.php';

// Ambil data user + outlet
$qUser = "
    SELECT u.*, o.nama AS outlet_nama 
    FROM tb_user u
    LEFT JOIN tb_outlet o ON u.outlet_id = o.id
    ORDER BY u.id DESC
";
                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="penggunaTable" class="table table-bordered table-hover table-striped align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?= $item->outlet_nama ?: '-' ?></td>

                                                    <td class="text-capitalize"><?= $item->role ?></td>
                                                    <td class="text-center">
                                                        <a href="./edit.php?id=<?= $item->id ?>" class="btn btn-warning btn-sm text-light">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <a href="../../actions/pengguna/destroy.php?id=<?= $item->id ?>"
